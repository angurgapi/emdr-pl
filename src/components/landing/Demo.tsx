      ...
      <Container>
        <div className="rounded-3xl border bg-white p-6 shadow-sm dark:bg-gray-800">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="text-lg font-medium">Demo na żywo</div>
            <div className="flex flex-wrap items-center gap-2 text-sm">
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="x">Poziomo</SelectItem>
                  <SelectItem value="y">Pionowo</SelectItem>
                  <SelectItem value="xy">Skośnie</SelectItem>
                </SelectContent>
              </Select>
              ...
              <Select onValueChange={(value) => setSpeed(parseFloat(value))}>
                ...
                <SelectContent>
                  <SelectItem value={"1.6"}>Spokojnie</SelectItem>
                  <SelectItem value={"1.2"}>Standardowo</SelectItem>
                  <SelectItem value={"0.8"}>Szybko</SelectItem>
                </SelectContent>
              </Select>
          ...
          <p className="mt-3 text-sm text-gray-500">
            To demo używa uproszczonej pętli animacji w celach poglądowych.
          </p>
        </div>
      </Container>
    </section>
